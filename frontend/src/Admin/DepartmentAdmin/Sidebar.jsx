...
const Sidebar = () => {
  ...
  return (
    <div className="font-poppins flex h-screen w-full relative">
  ...
  {menuItems.map(({ name, icon: Icon }) => {
    ...
    let to = "#"; 
    if (name === "Add Events") to = "/DepartmentAdmin/department-add-event";
    else if (name === "Add Events Details") to = "/DepartmentAdmin/department-add-event-details";
    else if (name === "Dashboard") to = "/super-admin/dashboard";
